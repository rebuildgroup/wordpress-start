...
/**
 * @class BBPhotoDuotoneModule
 */
class BBPhotoDuotoneModule extends FLBuilderModule {
	...
	public function __construct() {
		parent::__construct(array(
			'name'            => __( 'Photo - Duotone', 'fl-builder' ),
 ...
 */
FLBuilder::register_module('BBPhotoDuotoneModule', array(
	'general' => array( // Tab
