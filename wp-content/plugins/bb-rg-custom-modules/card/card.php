<?php
    class RGCardLinkModule extends FLBuilderModule {
        public function __construct() {
            parent::__construct(array(
                'name'            => __( 'Card', 'fl-builder' ),
                'description'     => __( 'A branded bootstrap card module.', 'fl-builder' ),
                'category'        => __( 'Special', 'fl-builder' ),
                'dir'             => BB_RG_MODULES_DIR . 'card/',
                'url'             => BB_RG_MODULES_URL . 'card/',
     ...
     */
    FLBuilder::register_module('RGCardLinkModule', array(
        'general'       => array( // Tab
            ...
            'sections'      => array( // Tab Sections
                ...
                'text'          => array(
                    ...
                    'fields'        => array(
                        'headline_text' => array(
                            'type'          => 'text',
                            'label'         => __( 'Headline Text', 'fl-builder' ),
                            'default'       => '',
                            'maxlength'     => '30',
                            'size'          => '30',
